...
<template>
    ...
    <div class="h-screen flex flex-col bg-white">
        <!-- Header -->
        <div class="h-24 bg-blue-600 text-white px-6 py-4 flex justify-between items-center border-b-4 border-blue-700">
        ...
        <div class="flex-1 overflow-y-auto px-6 py-6 text-center">
            <div class="max-w-3xl mx-auto">
                <div v-if="currentMyth">
                    ...
                    <a :href="currentMyth.link" target="_blank" class="text-blue-700 underline font-semibold mb-6 inline-block">
                        Read more...
                    </a>
                ...
                <div v-else class="text-blue-600 text-3xl font-bold mt-10">Myth not found.</div>
            </div>
        </div>
        ...
        <!-- Footer -->
        <div class="h-24 bg-blue-600 border-t-4 border-blue-700"></div>
    </div>
</template>

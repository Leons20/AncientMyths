...
<template>
    ...
    <div class="h-screen flex flex-col bg-white">
        <!-- Header -->
        <div class="h-24 bg-gray-500 text-white px-6 py-4 flex justify-between items-center border-b-4 border-gray-600">
        ...
        <div class="flex-1 overflow-y-auto px-6 py-6 text-center">
            <div class="max-w-3xl mx-auto">
                <div v-if="currentMyth">
                    ...
                    <a :href="currentMyth.link" target="_blank" class="text-gray-600 underline font-semibold mb-6 inline-block">
                        Read more...
                    </a>
                    ...
                    <div class="flex justify-center gap-4 mt-4">
                        <button
                            ...
                            @click="goToReview"
                            class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded font-semibold"
                        >
                            Write a Review
                        </button>
                ...
                <div v-else class="text-gray-500 text-3xl font-bold mt-10">Myth not found.</div>
            </div>
        </div>
        ...
        <!-- Footer -->
        <div class="h-24 bg-gray-500 border-t-4 border-gray-600"></div>
    </div>
</template>

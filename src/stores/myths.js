...
export const useMythStore = defineStore("myths", () => {
        ...
        Greek: [
            {
                ...
                myth: `Prometheus, a Titan, defies Zeus by stealing fire from the gods and giving it to humanity. This act of rebellion enables civilization but enrages Zeus, who punishes Prometheus by chaining him to a rock where an eagle eats his liver daily, only for it to regenerate.`,
        ...
        Hindu: [
            {
                ...
                myth: `In order to obtain amrita (the nectar of immortality), the gods and demons join forces to churn the cosmic ocean using Mount Mandara as a churning rod and the serpent Vasuki as a rope. The process yields both treasures and dangers, including poison which Shiva consumes to save the world.`,
        ...
        Chinese: [
            {
                ...
                myth: `After a great cosmic catastrophe damages the pillars of heaven and the earth cracks open, the goddess Nüwa melts five different-colored stones to repair the sky and slays a giant turtle to prop up the heavens. Her actions restore balance to the world.`,
        ...
        Mayan: [
            {
                ...
                myth: `Hunahpu and Xbalanque, the Hero Twins, descend into the Mayan underworld (Xibalba) to avenge their father's death. They outwit the gods of death through trials, trickery, and resurrection, ultimately becoming celestial bodies—the sun and the moon.`,
    ...
    function addMyth(mythology, newMyth) {
        if (!myths.value[mythology]) {
            myths.value[mythology] = [];
        }
        myths.value[mythology].push(newMyth);
    }
